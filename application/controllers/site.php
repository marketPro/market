...
class Site extends CI_Controller {
	...
	///////////////////////////////////////////////////////////////////////////////////// validate user
			...
			$this->form_validation->set_rules('email', 'Email', 
			                                 'required|trim|xss_clean|valid_email|max_length[100]|is_unique[user_temp.email]|is_unique[user.email]
											 ');
		
			$this->form_validation->set_rules('city', 'Country', 'required|max_length[30]|trim|xss_clean');
			
											 
			$this->form_validation->set_rules('address', 'Address', 'required|max_length[100]|trim|xss_clean');
			$this->form_validation->set_rules('phone', 'Phone', 'required|max_length[20]|trim|xss_clean');
...
//			
			...
			if($this->site_model->add_temp_user($key,$country)){
